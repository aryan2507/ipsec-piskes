...
func TestExistingImplementations(t *testing.T) {
	...
	_, found := KnownDerivations["scmp"]
	require.True(t, found, "\"scmp\" implementation not found")

	_, found = KnownDerivations["piskes"]
	require.True(t, found, "\"piskes\" implementation not found")
}
